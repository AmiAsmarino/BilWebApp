...
<head>
	...
	<link rel="icon" href="car_icon.png">
</head>
<body>
	            ...
	            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
	              <ul class="list-group">
	                ...
	                <a href="#" class="list-group-item ">
	                  <br/><br/><i class="glyphicon glyphicon-tasks"></i> Registrer Ny Kunde <br/><br/>
	                </a>  
	                <a href="#" class="list-group-item ">
	                  <br/><br/><i class="glyphicon glyphicon-transfer"></i> Bestille Time<br/><br/>
	                </a>
	                <a href="#" class="list-group-item">
	                  <br/><br/><h4 class="glyphicon glyphicon-wrench"></h4> Adresse Åpningstider<br/><br/>
	                </a>
	              </ul>
	            </div>
	            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
	                ...
	                <div class="bhoechie-tab-content">
	                    <center>
	                      ...
	                      <h2 style="margin-top: 0;color:#00001a"><a href="Register.jsp" class="btn btn-primary btn-block" role="button">Registrer</a></h2>
	                    </center>
	                </div>
	                ...
	                <div class="bhoechie-tab-content">
	                    <center>
	                      ...
	                      <h3 style="margin-top: 0;color:#848484">Her kan du bestille ny time!</h3>
	                       <h2 style="margin-top: 0;color:#2DD31B"><a href="Bestille.jsp" class="btn btn-success btn-block" role="button"> Bestille time</a></h2>
